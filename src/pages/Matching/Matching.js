...
const Matching = ({navigation, userList, ...props}) => {
        ...
        userList?.map((item, index) => (
          <View style={[f_full, {padding: 10}]}>
            ...
            <LinearGradient
              ...
              <View style={[f_full, justify_end, {paddingBottom: 40}]}>
                <Typography size="3xl" white bold></Typography>
                <View style={[flex_row, justify_between, p_4]}>
                  <View style={[flex_row]}>
                    <View style={[sp_3, justify_end, p_4]}>
